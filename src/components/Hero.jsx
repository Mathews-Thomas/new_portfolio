    ...
    >
      <div className="container mx-auto flex flex-col lg:flex-row items-center px-6">
        <div className="w-full lg:w-1/2 text-center lg:text-left mb-8 lg:mb-0">
          ...
          <h1 className="text-5xl font-bold mb-4">Kate Winslet</h1>
          ...
          <div className="flex justify-center lg:justify-start space-x-4 mt-6">
            <a 
              href="#contact" 
              className="btn bg-white text-red-600 border border-white transition-all duration-300 hover:bg-transparent hover:text-white"
            >
              Hire Me
            </a>
            <a 
